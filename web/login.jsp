...
<body>
<form id="fm1" class="fm-v clearfix" action="User_login.do" method="post" onsubmit="return submitForm()">
    <div id="Logo">
        ...
        <div id="Login">
			...
			<font color="red"><b></b></font>
                ...
                <div class="input_pwd">用户名:
                    ...
                    <input id="username" name="user.loginName" class="colorblur" tabindex="1" accesskey="n" type="text"
                ...
                <div class="input_pwd">密　码:
                    <input id="password" name="user.pwd" class="colorblur" tabindex="2" accesskey="p" type="password"
                ...
                <div class="input_post">
                    <input type="hidden" name="lt"
                           value="_c3F041F78-53B9-69A5-3B3C-01BAB6E90925_k37408022-0986-F9AF-9DBB-8FBEC82968E9"/>
