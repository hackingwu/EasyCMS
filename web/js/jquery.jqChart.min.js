(function (a) {
    a.fn.jqChart = function (b, d, e) {
        if (typeof b === "object")d = b; else if (typeof b === "string") {
            b = b.toLowerCase();
            if (a.fn.jqChart.methods[b])return a.fn.jqChart.methods[b].call(this, d, e); else a.error("Method " + method + " does not exist on jQuery.jqChart")
        }
    ...
    a.fn.jqChart.methods = {chart: function () {
    ...
    a.fn.jqDateFormat.i18n = {dayNames: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], monthNames: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]};
    function Kb(a) {
        this.callback = a;
        this.animations = []
    }

    Kb.prototype = {begin: function () {
    ...
    g.prototype = {_createElements: function (c) {
        ...
        if (!d && !f)return;
        var g = this.options.tooltips.snapArea, a = this._getTooltipShapes(c.locX, c.locY, g, c), e = true;
        ...
        if (d.result !== false)if (g.use_excanvas)this.hlRenderer._render(b); else {
        ...
        for (var d = [], f = this.shapes.length - 1; f >= 0; f--) {
            ...
            if (c === true)d.push(a); else c && d.push(c)
        }
    ...
    function Bb(b) {
        a.extend(this, {maxInter200Px: 8, lblMargin: 4, origin: 0, length: 300, x: 0, y: 0});
        this.setOptions(b)
    }

    Bb.prototype = {_calculateActualInterval: function (m, l) {
        ...
        if (this.labels && this.labels.position == "inside")return{postShapes: b, contextShapes: b};
        a.merge(c, b);
        return{contextShapes: b}
        ...
        for (var n = this._getLabelIntervals(o, c), p = n.length, r = c.showFirstLabel, s = c.showLastLabel, h = 0; h < p; h++) {
            ...
            switch (this.location) {
                ...
                case"top":
                    a.x = k;
                    if (g)a.y = this.y + this.height + e + a.height / 2; else a.y = this.y + this.height - e - a.height / 2 - j;
                    ...
                    if (this.labels.angle) {
                        ...
                        a.flip = d > 0;
                        if (d > 0)d = -180 + d;
                        var f = b.radians(d), i = Math.sqrt(a.width * a.width + a.height * a.height);
                ...
                case"bottom":
                    a.x = k;
                    if (g)a.y = this.y - e - a.height / 2; else a.y = this.y + e + a.height / 2 + j;
                    a.textBaseline = "middle";
                    switch (c.hAlign) {
                        case"center":
                            a.textAlign = "center";
        ...
        for (var k = [], h = this.offset, g = c.position == "inside", p = this._getMarkInterval(c, m), b = c.length, l = this._getIntervals(p, c, m), d, f, e, a, j = 0; j < l.length; j++) {
            ...
            switch (this.location) {
                case"left":
                    f = a = i;
                    if (g)e = this.x + this.width + b; else e = this.x + this.width - h;
                    d = e - b;
                    break;
                case"right":
                    f = a = i;
                    if (g)d = this.x - b; else d = this.x + h;
                    e = d + b;
                    break;
                case"top":
                    d = e = i;
                    if (g)a = this.y + this.height + b; else a = this.y + this.height - h;
                    f = a - b;
                    break;
                case"bottom":
                    d = e = i;
                    if (g)a = this.y - b; else a = this.y + h;
                    f = a + b
            }
            var o = new n(d, f, e, a);
        ...
        return d >= c && d <= a
    }, defaults: {location: "left", labels: {visible: true, fillStyle: "black", lineWidth: 1, font: "11px sans-serif", position: "outside", showLastLabel: true, showFirstLabel: true, hAlign: "center", vAlign: "center"}, title: {font: "14px sans-serif", margin: 2}, strokeStyle: "black", lineWidth: 1, margin: 5, crossing: 0, visible: true, reversed: false, zoomEnabled: false}};
    var j = -Number.MAX_VALUE, h = Number.MAX_VALUE;
    ...
    c.prototype._createGradient = function (h, c) {
        ...
        var d, b = {x0: 0, y0: 0, x1: 1, y1: 1, r0: 0, r1: 1};
        a.extend(b, c);
        switch (c.type) {
            case"radialGradient":
                var k = this.x + b.x0 * this.width, m = this.y + b.y0 * this.height, i = b.r0 * this.width / 2, l = this.x + b.x1 * this.width, n = this.y + b.y1 * this.height, j = b.r1 * this.width / 2;
                d = h.createRadialGradient(k, m, i, l, n, j);
                break;
            default:
                var q = this.x + b.x0 * this.width, r = this.y + b.y0 * this.height, p = this.x + b.x1 * this.width, o = this.y + b.y1 * this.height;
    ...
    n.prototype.hitTestNonHV = function (k, l, j) {
        ...
        var n = Math.sqrt(e * e + f * f), m = (e * k - f * l + i) / n, o = Math.max(j, 3);
    ...
    i.prototype.render = function (d, o) {
        ...
        var k = this.strokeStyle != null && this.lineWidth > 0, n = k && Math.floor(this.lineWidth % 2) ? b.roundH : Math.round, m = this.correction || 0;
        m = Math.round(m);
        var h = n(this.x), j = n(this.y), f = Math.round(this.width), e = Math.round(this.height), a = this.context;
        if (this.xDecrease) {
            var l = a.series.realYAxis.crossing, g = Math.round(this.xDecrease);
            f -= g;
            if (a && (a.y < l || a.from >= a.to))h += g
        }
        if (!b.isNull(this.yDecrease)) {
            var l = a.series.realYAxis.crossing, g = Math.round(this.yDecrease);
            e -= g;
            if (!a || a.y >= l || a.from < a.to)j += g
        }
        if (f <= 0 || e <= 0)return;
        if (this.cornerRadius == 0)i.renderRectPath(d, h, j, f, e); else this.renderRoundedRectPath(d, h, j, f, e);
    ...
    Eb.prototype.render = function (a, m) {
        ...
        var d = this.x, f = this.y, l = this.width, k = this.height, g = this.width / 2 * .5522848, h = this.height / 2 * .5522848, i = d + l, j = f + k, e = d + l / 2, b = f + k / 2;
        a.beginPath();
        a.moveTo(d, b);
    ...
    mb.prototype.render = function (a, e) {
        ...
        a.beginPath();
        var b = Math.round(this.x), d = Math.round(this.y);
        a.moveTo(b, d);
    ...
    t.prototype.createHighlightMark = function (c) {
        if (c == -1)return null;
        var d = this.context, f = this.pts, g = d.points[c / 2], e = 5, b = new ab(f[c] - e, f[c + 1] - e, e);
    ...
    bb.prototype.render = function (d, g) {
        ...
        if (f <= 2)return;
        var e;
        if (this.isCurve)e = new u(a); else e = new C(a);
        d.beginPath();
        d.moveTo(a[0], a[1]);
        e.renderPoints(d, a);
        if (this.vertical) {
    ...
    fb.prototype.render = function (d, h) {
        ...
        if (g < 2)return;
        var f;
        if (this.isCurve)f = new u(e); else f = new C(e);
        d.beginPath();
        d.moveTo(e[0], e[1]);
        f.renderPoints(d, e);
        d.lineTo(a[0], a[1]);
        if (this.isCurve)f = new u(a); else f = new C(a);
        f.renderPoints(d, a);
        d.closePath();
        this.fillStyle != null && d.fill();
        this.strokeStyle != null && this.lineWidth > 0 && d.stroke()
    ...
    O.prototype._renderShadows = function (h) {
        if (g.use_excanvas)return;
        var f = this.offsetX && this.offsetY, c = this.chart.options;
    ...
    function T(a) {
        this.defaults = {font: "14px sans-serif", fillStyle: "black", lineWidth: 0, margin: 6};
        this.x = 0;
        this.y = 0;
        this.setOptions(a)
    }
    ...
    function hb(a) {
        this.defaults = {visible: true, strokeStyle: "black", lineWidth: 1, lineCap: "butt", lineJoin: "miter", miterLimit: 10, cornerRadius: 10, padding: 4};
        this.x = 0;
        this.y = 0;
        this.setOptions(a)
    }
    ...
    hb.prototype._render = function (c) {
        if (!this.visible)return;
        var a = this.lineWidth / 2, f = this.x + a, g = this.y + a, e = this.width - 2 * a, d = this.height - 2 * a, b = new i(f, g, e, d);
    ...
    function Hb(a) {
        this.defaults = {fillStyle: "rgba(204, 204, 204, 0.5)", lineWidth: 1};
        this.setOptions(a)
    }
    ...
    f.prototype._setOptions = function (j) {
        ...
        var d = j || {};
        if (d.width)this.elem.css("width", d.width); else this.elem.width() == 0 && this.elem.css("width", "400px");
        if (d.height)this.elem.css("height", d.height); else this.elem.height() == 0 && this.elem.css("height", "250px");
        ...
        var h = this.options.scaleX, i = this.options.scaleY;
        if (h && i) {
            this._width /= h;
            this._height /= i;
    ...
    f.prototype._arrange = function () {
        ...
        f -= 2 * c;
        g -= 2 * c;
        var d = c, e = c + this.title.height, m = this.axes._getTotalWidth(), l = this.axes._getTotalHeight();
    ...
    f.prototype._getClosestShapeAtX = function (e, f) {
        for (var c = null, i = h, j = f.locX, d = e.length - 1; d >= 0; d--) {
            var a = e[d];
            if (!a.context || a.isLegendItem || a.isAxisLabel)continue;
            var b = a.getCenter(f), g = Math.abs(b.x - j);
            if (i > g) {
                i = g;
                c = a;
                if (b.mark)c = b.mark
        ...
        a.each(e, function () {
            if (this != c && this.context && !this.isLegendItem && !this.isAxisLabel) {
                ...
                if (a.inArray(h, d) == -1 && Math.abs(g - e.x) < 3) {
                    if (e.mark)b.push(e.mark); else b.push(this);
                    d.push(h)
                }
            }
        });
    ...
    f.prototype._renderSelectionRect = function (g, h) {
        ...
        var m = Math.min(c, d), n = Math.min(e, f), l = Math.abs(c - d), k = Math.abs(e - f), j = new i(m, n, l, k);
    ...
    f.prototype._renderShapes = function () {
        this.shapeRenderer._clear();
        g.use_excanvas && this.areaRenderer._clear();
        var e = this.gridArea, a = this.allShapes;
        this.shapeRenderer._render(a.shapes);
        var d = a.gaShapes;
        if (g.use_excanvas)this.areaRenderer._render(d); else {
            this.ctx.save();
        ...
        if (g.use_excanvas)this.areaRenderer._render(b); else {
            this.ctx.save();
            this._setClip(this.ctx);
    ...
    function K(d, a, b, g, e, f) {
        ...
        this.y = Math.min(a, b);
        this.isUp = e < g;
        this.tooltipOrigin = {x: d, y: Math.min(a, b)};
        this.center = {x: d, y: (g + e) / 2};
    ...
    cb.prototype.createElements = function (b, e, f, o, l, m) {
        var d = [], g = Math.floor(m / 2), b = Math.round(b), a = Math.round(o), c = Math.round(l);
        if (a > c) {
            var k = c;
            c = a;
            a = k
    ...
    cb.prototype.render = function (d) {
        ...
        for (var b = 0; b < this.items.length; b++) {
            var a = this.items[b];
            this.setProperties(a);
            if (a instanceof i)if (this.isUp)a.fillStyle = this.priceUpFillStyle; else a.fillStyle = this.priceDownFillStyle;
            a.render(d)
        }
    };
    ...
    Ib.prototype = {_init: function () {
        ...
        var e = b.outerWidth(), h = b.outerHeight(), d = c.gridArea, f = d.x + d.width - e, g = d.y;
        b.css({left: f, top: g})
    ...
    function R(a) {
        this.defaults = {lineWidth: 1, lineCap: "butt", lineJoin: "miter", miterLimit: 10, size: 8, offset: 0, linkLineWidth: 1, type: "circle"};
        this.setOptions(a)
    }
    ...
    function Mb(a) {
        this.defaults = {strokeStyle: "gray", lineWidth: 1, title: {margin: 2, hAlign: "left", vAlign: "top"}};
        this.setOptions(a)
    }

    Mb.prototype = {_setLineSettings: function (a) {
        a.strokeStyle = this.strokeStyle;
        a.lineWidth = this.lineWidth;
        a.strokeDashArray = this.strokeDashArray
    ...
    function Lb(a) {
        this.defaults = {fillStyle: "gray", lineWidth: 0, title: {margin: 2, hAlign: "left", vAlign: "top"}};
        this.setOptions(a)
    }
    ...
    function ib(a) {
        this.defaults = {location: "right", title: {margin: 0}, border: {padding: 2, strokeStyle: "grey", cornerRadius: 6}, margin: 4, visible: true};
        this._itemMargin = 4;
        this.setOptions(a)
    }
    ...
    ib.prototype._init = function () {
        ...
        if (this.customItems)for (var d = 0; d < this.customItems.length; d++) {
            ...
            var h = {marker: {type: "rectangle", fillStyle: "#418CF0"}};
            b = a.extend(true, {}, h, b || {});
            ...
            e.chart = this.chart;
            this.items.push(e)
        } else for (var g = {font: this.font, textStrokeStyle: this.textStrokeStyle, textFillStyle: this.textFillStyle, textLineWidth: this.textLineWidth, cursor: this.itemsCursor}, f = this.chart.series.items, d = 0; d < f.length; d++) {
            var j = f[d];
    ...
    ib.prototype._measure = function () {
        ...
        var h = 2 * this.margin + 2 * this.padding, k = this.chart._width - 2 * this.chart.border.getPadding() - h;
        if (j && b > k) {
            var e = Math.floor(k / d) || 1, l = Math.ceil(this.items.length / e);
            this.rows = e;
    ...
    ib.prototype._arrange = function () {
        ...
        for (var h = this._isHorizontal(), e = this.rows, c = 0; c < this.items.length; c++) {
            ...
            } else d += a.width + this._itemMargin; else b += a.height;
            a._arrange()
        }
    };
    ...
    function eb(a) {
        this.defaults = {font: "12px sans-serif", textFillStyle: "black"};
        this.lblMargin = 4;
        this.setOptions(a)
    }
    ...
    y.prototype._arrangeRenderer = function (a) {
        if (!g.use_excanvas)return;
        var e = this.x, f = this.y, b = a.canvas, h = a.div, d = Math.max(this.width, 0), c = Math.max(this.height, 0);
        h.css({left: e, top: f, width: d, height: c});
        b.width = d;
        b.height = c;
        a.offsetX = -e;
        a.offsetY = -f
    ...
    y.prototype._renderPlots = function (c) {
        for (var d = this.chart.axes.items, b = 0; b < d.length; b++) {
            var e = d[b], f = this._getPlotBands(e);
            a.merge(c, f);
    ...
    y.prototype._getStripes = function (b) {
        ...
        a.each(d, function () {
            var a = new Hb(this), k;
            if (a.interval)k = a.interval; else k = 2 * b.actualInterval;
            var j;
            if (a.width)j = a.width; else j = b.actualInterval;
            for (var h = a.lineWidth, o = h / 2, n = b._getIntervals(k, a, true), m = 0; m < n.length; m++) {
                ...
                if (b.isAxisVertical)g = new i(c.x + o, Math.min(d, f), c.width - h, Math.abs(f - d)); else g = new i(Math.min(d, f), c.y + o, Math.abs(f - d), c.height - h);
                a._setSettings(g);
                e.push(g)
            }
        });
    ...
    y.prototype._getPlotLines = function (h) {
        ...
        for (var e = this, i = [], j = 0; j < g.length; j++) {
            ...
            d.setOptions(g[j]);
            var f = d.lineWidth / 2, l = h.getPosition(d.value), c = new T(d.title);
            c.chart = this.chart;
            c._measure();
            if (h.isAxisVertical) {
                y1 = y2 = l;
    ...
    v.prototype._findStackedClusters = function (h, e) {
        ...
        return{index: i, count: b, groupIndex: l, groupCount: k}
    };
    ...
    e.prototype = {_getMarker: function (d, e, b, f, c) {
        ...
        var a = this._correctMarkerPosition(d, e, c), f = this._getMarker(a.x, a.y, i, c, h), g = this.markers.offset, b = null;
        if (g) {
            b = new n(d, e, a.x, a.y);
            this.markers._setLineSettings(b);
            this._setMarkerLinkLineSettings(b)
        }
        return{marker: f, line: b, offset: a.offset}
        ...
        if (this.markers && this.markers.isVisible() && this.realYAxis.isValueVisible(c)) {
            if (!d)d = {chart: this.chart, series: this, dataItem: this.data[a], index: a, x: this.realXAxis._getValue(p), y: c};
        ...
        if (this.labels && this.labels.visible !== false) {
            var l = this._getLabelValue(c, a), e = this._getDataPointLabel(c, j, k, m + g, l);
            e.context = {chart: this.chart, series: this, dataItem: this.data[a], index: a};
        ...
        var a = new kb(b, e, "visible", false, true), c = a.duration / f, d = a.delayTime + g * c;
        a.delayTime = d;
        a.duration = c;
        ...
        if (this.fillStyles && !b.isNull(c))a.fillStyle = this.fillStyles[c % this.fillStyles.length]; else a.fillStyle = this.fillStyle;
        a.strokeStyle = this.strokeStyle;
        a.lineWidth = this.lineWidth;
        a.lineCap = this.lineCap;
        a.lineJoin = this.lineJoin;
        ...
        var a = this.realXAxis, e = a.visibleMinimum || a.minimum, d = a.visibleMaximum || a.maximum, m = !b.isNull(e), l = !b.isNull(d);
        if (!m && !l)return;
        if (a.skipEmptyDays) {
        ...
        if (this.realYAxis.zoomEnabled)return;
        var e = this.realXAxis, o = e.visibleMinimum || e.minimum, n = e.visibleMaximum || e.maximum, l = !b.isNull(o), k = !b.isNull(n);
        if (!l && !k)return;
        ...
        if (this.realYAxis.zoomEnabled)return;
        var c = this.realXAxis, n = c.visibleMinimum || c.minimum, m = c.visibleMaximum || c.maximum, k = !b.isNull(n), i = !b.isNull(m);
        if (!k && !i)return;
        ...
        if (this.realYAxis.zoomEnabled)return;
        var a = this.realXAxis, d = a.visibleMinimum || a.minimum, c = a.visibleMaximum || a.maximum, n = !b.isNull(d), m = !b.isNull(c);
        if (!n && !m)return;
        if (a.skipEmptyDays) {
            d = a._addEmptyDaysOffset(d);
        ...
        var a = new k({location: "left", orientation: "y"});
        a.chart = this.chart;
        return a
        ...
        var f = [], d;
        if (this.title != null)d = this.title; else {
        ...
        var g = {chart: this.chart, series: this};
        c = a.extend(false, {}, c, {context: g, text: d, marker: b});
        var e = new eb(c);
        e.chart = this.chart;
        e.series = this;
        f.push(e);
        ...
        if (e)b = d.height / 2 + c.height + h; else b = d.width / 2 + c.width + h;
        if (j && !e || !j && e) {
            b += g;
            b *= 1.25;
            var k = b / f.length;
        ...
        if (f.getOrientation(this) == "x")b = Math.max(b, 6); else b = Math.max(b, 12);
        ...
        var f = i >= this.realYAxis.crossing, h = this._getLabelText(e), b = new q(h);
        ...
        var g = this.chart.series._findStackedClusters(this, b), e = this.chart.series._getStackedSeriesFromType(b, this.stackedGroupName), d = this._calcStackedData(c, g, e);
        a.extend(this, d)
        ...
        var c = this.data;
        if (a.isArray(c) == false)return;
        var g = this.chart.series._findStackedClusters(this, b), e = this.chart.series._getStackedSeriesFromType(b, this.stackedGroupName), d = this._calcVisibleStackedData(c, g, e);
        a.extend(this, d)
        ...
        for (var i = h, g = j, f = [], p = m.length, k = [], d = 0; d < p; d++) {
            var b = {positive: 0, negative: 0}, e = null;
            if (l.index > 0) {
            ...
            if (a.isArray(c) == false)f.push((d + 1).toString()); else f.push(c[0]);
        ...
        var o = {min: i, max: g, dataValues: k, categories: f};
        return o
    }, _calcVisibleStackedData: function (n, m, q) {
        var g = this.realXAxis, u = this.realYAxis, t = g.zoomEnabled, v = u.zoomEnabled;
        if (v || !t)return;
        var p = g.visibleMinimum, o = g.visibleMaximum;
        if (b.isNull(p) || b.isNull(o))return;
        for (var k = h, i = j, r = [], w = n.length, l = [], e = 0; e < w; e++) {
            if (e + 1 < p || e > o)continue;
            var c = {positive: 0, negative: 0}, f = null;
            if (m.index > 0) {
        ...
        var s = {min: k, max: i, dataValues: l, categories: r};
        return s
        ...
        var c = this.chart.series._getSeriesFromType(this.type), b = 0;
        ...
        return 1;
        var c = this.realXAxis.series, b = this.realXAxis.actualMinimum, a = this.realXAxis.actualMaximum;
    ...
    }, defaults: {nullHandling: "break", lineCap: "butt", lineJoin: "round", lineWidth: 1, strokeStyle: null, miterLimit: 10, pointWidth: .6}};
    function J(b) {
    ...
    J.prototype._renderCatValueData = function (j) {
        for (var o = this.data.length, f = this.markers != null && this.markers.isVisible(), c = [], i = [], n = [], l = [], q = f ? this.markers.size / 2 : 0, h, k, p, d, e = 0; e < o; e++) {
            ...
            c.push(h);
            c.push(k);
            !f && i.push({dataItem: g, index: e, x: p, y: d});
            if (this.realYAxis.isValueVisible(d) === false)continue;
            this._addMarkerAndLabel(n, l, h, k, e, o, null, d, q)
        }
        var m = this._createShape(c, j);
        if (!f && m)m.context = {chart: this.chart, series: this, points: i}; else a.merge(j, n);
        a.merge(j, l)
    };
    J.prototype._renderXYData = function (i) {
        var k = this.data.length, d = this.markers != null && this.markers.isVisible(), q = this.labels != null && this.labels.visible !== false;
    ...
    Z.prototype._createShape = function (i, h) {
        ...
        var f = this.chart.gridArea, k = f.y, j = f.y + f.height, e = this.realYAxis.getCrossingPosition();
    ...
    o.prototype._findXAxis = function (b) {
        ...
        if (a != null)return a;
        var c;
        if (this.categories)c = E; else c = k;
        for (var d = 0; d < b.length; d++) {
            a = b[d];
    ...
    o.prototype._renderCatData = function (p) {
        var j = this.chart.gridArea, y = j.x, D = y + j.width, e = this.realYAxis.getCrossingPosition();
        e = b.fitInRange(e, y, D);
        e = Math.round(e);
        var q = this.chart.series._findClusters(this, this.type), m = this._getDataLengthSum(), B = j.height / this.realXAxis.getZoom(), w = B / m, E = w / q.count, h = Math.round(this.pointWidth * E), A = q.count * h, o = (w - A) / 2;
        o = Math.round(o + q.index * h);
        for (var u = [], r = [], C = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, c, l, d = 0; d < m; d++) {
            var n = this.data[d];
            if (n == null)continue;
            var F = d, g;
            if (a.isArray(n) == false)g = n; else g = n[1];
            if (g == null)continue;
            ...
            var t = {chart: this.chart, series: this, dataItem: this.data[d], index: d, x: this.realXAxis._getValue(d), y: g}, k = new i(c, l, f, h);
            k.context = t;
            k.center = {x: Math.round(z), y: Math.round(l + h / 2)};
    ...
    o.prototype._renderLinearData = function (m) {
        var g = this.chart.gridArea, w = g.x, C = w + g.width, d = this.realYAxis.getCrossingPosition();
        ...
        for (var j = this._getDataLengthSum(), z = g.height / this.realXAxis.getZoom(), n = this._getScaleDiff(), B = n * z / j, p = this.pointWidth * B, u = [], r = [], A = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, c, q, e = 0; e < j; e++) {
            ...
            var t = {chart: this.chart, series: this, dataItem: this.data[e], index: e, x: o, y: k};
            ...
            var x = q - p / 2, h = new i(c, x, f, p);
            h.context = t;
            h.center = {x: Math.round(y), y: Math.round(x + p / 2)};
    ...
    o.prototype._addAnimation = function (d, g, f) {
        var b = this._getAnimation();
        if (!b || b.enabled === false)return;
        var a = new gb(b, d, "xDecrease", d.width, 0), c = a.duration / f, e = a.delayTime + g * c;
        a.delayTime = e;
        a.duration = c;
        this.chart.storyboard.addAnimation(a)
    };
    ...
    o.prototype._getPixelMargins = function (a) {
        if (a.isVertical() == false) {
            var b = e.prototype._getPixelMargins.call(this, a), c = a.length / 10, i = Math.max(c, b.left), h = Math.max(c, b.right);
            return{left: i, right: h}
        }
        if (this.data == null)return{left: 0, right: 0};
        var g = 4, j = this._getDataLengthSum(), f = a.length, d = .5 * f / j + g;
    ...
    o.prototype._getDataPointLabel = function (k, f, l, e, h) {
        var i = k <= this.realYAxis.crossing, j = this._getLabelText(h), b = new q(j);
        g.setShadows(b, this, this.chart);
        a.extend(b, this.labels);
        b.measure(this.chart.ctx);
        b.y = l;
    ...
    X.prototype._render = function (l) {
        ...
        for (var i = this.data.length, j, k, e, c, b, a = 0; a < i; a++) {
            ...
            if (this.markers && this.markers.isVisible()) {
                var s = {chart: this.chart, series: this, dataItem: this.data[a], index: a, x: c, y: b, size: e}, h = this._getMarker(j, k, p / 2);
                h.context = s;
                l.push(h);
                this._addShapeAnimation(h, a, i)
            }
            if (this.labels && this.labels.visible !== false) {
                var r = this._getLabelValue(b, a), m = this._getDataPointLabel(b, j, k, p / 2, r);
                l.push(m);
    ...
    A.prototype._renderCatData = function (p) {
        var k = this.chart.gridArea, B = k.y, A = k.y + k.height, d = this.realYAxis.getCrossingPosition();
        d = b.fitInRange(d, B, A);
        d = Math.round(d);
        var q = this.chart.series._findClusters(this, this.type), l = this._getDataLengthSum(), x = k.width / this.realXAxis.getZoom(), u = x / l, z = u / q.count, j = Math.round(this.pointWidth * z), w = q.count * j, o = (u - w) / 2;
        ...
        for (var t = [], r = [], y = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, c = 0; c < l; c++) {
            ...
            var s = {chart: this.chart, series: this, dataItem: this.data[c], index: c, x: this.realXAxis._getValue(c), y: e}, h = new i(f, g, j, n);
            h.context = s;
            h.center = {x: Math.round(f + j / 2), y: Math.round(v)};
    ...
    A.prototype._renderLinearData = function (n) {
        var j = this.chart.gridArea, z = j.y, x = j.y + j.height, c = this.realYAxis.getCrossingPosition();
        ...
        for (var k = this._getDataLengthSum(), u = j.width / this.realXAxis.getZoom(), y = this._getScaleDiff(), w = y * u / k, o = this.pointWidth * w, r = [], p = [], v = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, e, f, d = 0; d < k; d++) {
            ...
            var q = {chart: this.chart, series: this, dataItem: this.data[d], index: d, x: e, y: h};
            ...
            var s = e - o / 2, g = new i(s, f, o, m);
            g.context = q;
            g.center = {x: Math.round(s + o / 2), y: Math.round(t)};
    ...
    A.prototype._addAnimation = function (d, g, f) {
        var b = this._getAnimation();
        if (!b || b.enabled === false)return;
        var a = new gb(b, d, "yDecrease", d.height, 0), c = a.duration / f, e = a.delayTime + g * c;
        a.delayTime = e;
        a.duration = c;
        this.chart.storyboard.addAnimation(a)
    };
    ...
    x.prototype._render = function (s) {
        ...
        if (o < n)h = o / 2 - r; else h = n / 2 - r;
        if (h < 0)return;
        for (var w = k.x + o / 2, x = k.y + n / 2, u = Math.PI * 2 / v, f = -Math.PI / 2, m = this.fillStyles, c = 0; c < l; c++) {
            var e = j[c], i = f + e * u, g = new mb(w, x, h, f, i);
            this._setShapeSettings(g);
            if (m)g.fillStyle = m[c % m.length]; else g.fillStyle = this.palette.getColor(c);
            var y = {chart: this.chart, series: this, dataItem: this.data[c], index: c, value: e};
            g.context = y;
            s.push(g);
        ...
        for (var f = -Math.PI / 2, c = 0; c < l; c++) {
            ...
            if (e == 0)continue;
            var z = this._getLabelText(e), d = new q(z);
            d.textBaseline = "top";
            a.extend(d, this.labels);
            var t = d.measure(this.chart.ctx), p = this._getSliceCenter(w, x, (f + i) / 2, h * .6);
            d.x = p.x - t.width / 2;
            d.y = p.y - t.height / 2;
            d.context = {chart: this.chart, series: this, dataItem: this.data[c], index: c, value: e};
    ...
    x.prototype._getLegendItems = function (d) {
        ...
        for (var j = this._getYValues(), f, l = this.data.length, b = 0; b < l; b++) {
            ...
            var i = {chart: this.chart, series: this, dataItem: c, index: b, value: j[b]};
            d = a.extend(false, {}, d, {context: i, text: f, marker: h});
            var g = new eb(d);
            g.chart = this.chart;
            g.series = this;
            e.push(g)
    ...
    x.prototype._getTooltip = function (b) {
        ...
        var c = "<b>" + b.value + " (" + a + ")</b><br/>", d = b.dataItem[0];
        if (d)c = d + "</br>" + c;
        return c
    };
    x.prototype._addSliceAnimation = function (c, g, f) {
        var b = this._getAnimation();
        if (!b || b.enabled === false)return;
        var a = new gb(b, c, "endAngle", c.startAngle, c.endAngle), d = a.duration / f, e = a.delayTime + g * d;
        a.delayTime = e;
        a.duration = d;
        this.chart.storyboard.addAnimation(a)
    };
    ...
    U.prototype._render = function (u) {
        if (!this.data)return;
        var q = this.chart.gridArea, K = q.y, J = q.y + q.height, h = this.realYAxis.getCrossingPosition();
        h = b.fitInRange(h, K, J);
        h = Math.round(h);
        var c = this.chart.series._findStackedClusters(this, "stackedcolumn"), C = this.data.length, F = q.width / this.realXAxis.getZoom(), A = F / C, I = A / c.groupCount, m = Math.round(this.pointWidth * I), E = c.groupCount * m, t = (A - E) / 2;
        ...
        for (var z = [], y = [], w = this.chart.series._getStackedSeriesFromType("stackedcolumn", this.stackedGroupName), G = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, e, f, g, d = 0; d < C; d++) {
            ...
            var r = {chart: this.chart, series: this, dataItem: this.data[d], index: d, value: g.actualValue, x: this.realXAxis._getValue(d), y: l}, k = new i(e, f, m, p);
            k.context = r;
            k.center = {x: Math.round(e + m / 2), y: Math.round(v)};
            this._setShapeSettings(k, d);
            u.push(k);
            ...
            if (this.labels && this.labels.visible !== false && g.actualValue != 0) {
                ...
                switch (this.labels.valueType) {
                    case"percentage":
                        var B = this._getStackedTotal(w, d), D = n > 0 ? B.positive : B.negative;
                        n = D != 0 ? 100 * Math.abs(n) / Math.abs(D) : 0
                }
                var x = this.labels.position == "outside", H = x ? G : -p / 2, j = this._getDataPointLabel(g.actualValue, e, v, H, n);
    ...
    V.prototype._render = function (t) {
        if (!this.data)return;
        var u = this.chart.gridArea, C = u.x, J = C + u.width, k = this.realYAxis.getCrossingPosition();
        k = b.fitInRange(k, C, J);
        k = Math.round(k);
        var c = this.chart.series._findStackedClusters(this, "stackedbar"), D = this.data.length, G = u.height / this.realXAxis.getZoom(), A = G / D, K = A / c.groupCount, h = Math.round(this.pointWidth * K), F = c.groupCount * h, s = (A - F) / 2;
        ...
        for (var z = [], y = [], w = this.chart.series._getStackedSeriesFromType("stackedbar", this.stackedGroupName), H = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, e, j, g, d = 0; d < D; d++) {
            ...
            var q = {chart: this.chart, series: this, dataItem: this.data[d], index: d, value: g.actualValue, x: this.realXAxis._getValue(d), y: m}, l = new i(e, j, p, h);
            l.context = q;
            l.center = {x: Math.round(v), y: Math.round(j + h / 2)};
            ...
            if (this.labels && this.labels.visible !== false && g.actualValue != 0) {
                ...
                switch (this.labels.valueType) {
                    case"percentage":
                        var B = this._getStackedTotal(w, d), E = n > 0 ? B.positive : B.negative;
                        n = E != 0 ? 100 * Math.abs(n) / Math.abs(E) : 0
                }
                var x = this.labels.position == "outside", I = x ? H : -p / 2, f = this._getDataPointLabel(g.actualValue, v, j, I, n);
                if (!x) {
    ...
    G.prototype._renderCatData = function (u) {
        var v = this.chart.gridArea, b = this.chart.series._findClusters(this, this.type), g = this._getDataLengthSum();
        b.count = 1;
        b.index = 0;
        var q = v.width / this.realXAxis.getZoom(), m = q / g, r = m / b.count, l = Math.round(this.pointWidth * r), p = b.count * l, d = (m - p) / 2;
        ...
        for (var o, j, k, n, e, f, a = 0; a < g; a++) {
            ...
            var s = {chart: this.chart, series: this, dataItem: this.data[a], index: a, x: this.realXAxis._getValue(a), from: e, to: f}, w = Math.min(j, k), t = Math.abs(j - k), c = new i(o, w, l, t);
            c.context = s;
    ...
    G.prototype._renderLinearData = function (r) {
        for (var s = this.chart.gridArea, k = this._getDataLengthSum(), n = s.width / this.realXAxis.getZoom(), o = n / k, l = this.pointWidth * o, m, h, j, g, e, f, b = 0; b < k; b++) {
            ...
            e = c[1];
            f = c[2];
            var p = {chart: this.chart, series: this, dataItem: this.data[b], index: b, x: g, from: e, to: f};
            m = this.realXAxis.getPosition(g);
            h = Math.round(this.realYAxis.getPosition(e));
            j = Math.round(this.realYAxis.getPosition(f));
            var t = m - l / 2, u = Math.min(h, j), q = Math.abs(h - j), d = new i(t, u, l, q);
            d.context = p;
    ...
    H.prototype._renderCatData = function (s) {
        var t = this.chart.gridArea, b = this.chart.series._findClusters(this, this.type), h = this._getDataLengthSum();
        b.count = 1;
        b.index = 0;
        var q = t.height / this.realXAxis.getZoom(), m = q / h, v = m / b.count, d = Math.round(this.pointWidth * v), p = b.count * d, e = (m - p) / 2;
        ...
        for (var k, l, o, n, f, g, a = 0; a < h; a++) {
            ...
            var r = {chart: this.chart, series: this, dataItem: this.data[a], index: a, x: this.realXAxis._getValue(a), from: f, to: g}, w = Math.min(k, l), u = Math.abs(k - l), c = new i(w, o, u, d);
            c.context = r;
            this._setShapeSettings(c, a);
            s.push(c);
    ...
    H.prototype._renderLinearData = function (q) {
        for (var r = this.chart.gridArea, g = this._getDataLengthSum(), n = r.height / this.realXAxis.getZoom(), p = n / g, l = this.pointWidth * p, j, k, m, h, e, f, b = 0; b < g; b++) {
            ...
            e = c[1];
            f = c[2];
            var o = {chart: this.chart, series: this, dataItem: this.data[b], index: b, x: h, from: e, to: f};
            m = this.realXAxis.getPosition(h);
            j = Math.round(this.realYAxis.getPosition(e));
            k = Math.round(this.realYAxis.getPosition(f));
            var t = m - l / 2, u = Math.min(j, k), s = Math.abs(j - k), d = new i(u, t, s, l);
            d.context = o;
            this._setShapeSettings(d, b);
            q.push(d);
    ...
    B.prototype._render = function (o) {
        ...
        for (var c = 0; c < i; c++) {
            ...
            g = b[3];
            e = b[4];
            var n = {chart: this.chart, series: this, dataItem: b, index: c, x: this.realXAxis._getValue(k), high: f, low: h, open: g, close: e};
    ...
    B.prototype._getPixelMargins = function (a) {
        ...
        if (this.data == null)return{left: 0, right: 0};
        var d = 4, f = this.data.length, c = a.length, b = .5 * c / f + d;
        return{left: b, right: b}
    };
    ...
    z.prototype._render = function (l) {
        ...
        for (var x = this.data.length, i = this.markers != null && this.markers.isVisible(), s = this.labels != null && this.labels.visible !== false, e = [], j = [], n = [], m = [], t = i ? this.markers.size / 2 : 0, g, h, d, y = this.realYAxis.cx, p = this.realYAxis.cy, c = 0; c < x; c++) {
            ...
            e.push(h);
            if (i) {
                var u = {chart: this.chart, series: this, dataItem: f, index: c, x: this.realXAxis._getValue(c), y: d}, o = this._getMarker(g, h);
                o.context = u;
                n.push(o)
            } else j.push({dataItem: f, index: c, x: this.realXAxis._getValue(c), y: d});
            if (s) {
                var r = this._getLabelValue(d, c), v = this._getDataPointLabel(d, g, h, t, r);
                m.push(v)
            }
        }
        ...
        if (k) {
            l.push(k);
            if (!i)k.context = {chart: this.chart, series: this, points: j}
        }
        a.merge(l, n);
        a.merge(l, m)
    };
    ...
    w.prototype._render = function (m) {
        ...
        for (var y = this.data.length, h = this.markers != null && this.markers.isVisible(), t = this.labels != null && this.labels.visible !== false, c = [], j = [], o = [], n = [], u = h ? this.markers.size / 2 : 0, f, g, i, d, z = this.realYAxis.cx, q = this.realYAxis.cy, e = 0; e < y; e++) {
            ...
            c.push(g);
            if (h) {
                var v = {chart: this.chart, series: this, dataItem: this.data[e], index: e, x: i, y: d}, p = this._getMarker(f, g);
                p.context = v;
                o.push(p)
            } else j.push({dataItem: k, index: e, x: i, y: d});
            if (t) {
                var s = this._getLabelValue(d, e), w = this._getDataPointLabel(d, f, g, u, s);
                n.push(w)
            }
        }
        ...
        if (l) {
            m.push(l);
            if (!h)l.context = {chart: this.chart, series: this, points: j}
        }
        a.merge(m, o);
        a.merge(m, n)
    };
    ...
    I.prototype._renderXYData = function (j) {
        ...
        if (!e && n)n.context = {chart: this.chart, series: this, points: h}; else a.merge(j, o);
        a.merge(j, m)
    };
    ...
    W.prototype._createShape = function (i, h) {
        ...
        var c = new C(g);
        this._setShapeSettings(c);
        var f = this.chart.gridArea, k = f.x, j = f.x + f.width, e = this.realYAxis.getCrossingPosition();
        e = b.fitInRange(e, k, j);
    ...
    s.prototype._renderCatValueData = function (k) {
        for (var l = this.data.length, e = this.markers != null && this.markers.isVisible(), c = [], d = [], f = [], r = [], p = [], s = e ? this.markers.size / 2 : 0, j, n, o, m, g, h, b = 0; b < l; b++) {
            ...
            d.push(j);
            d.push(o);
            if (!e)f[b] = f[2 * l - b - 1] = {dataItem: i, index: b, x: m, from: g, to: h};
            this._addMarkersAndLabels(r, p, j, n, o, b, l, null, g, h, s)
        }
        var q = this._createShape(c, d, k);
        if (!e && q)q.context = {chart: this.chart, series: this, points: f}; else a.merge(k, r);
        a.merge(k, p)
    };
    s.prototype._renderXYData = function (i) {
        for (var l = this.data.length, d = this.markers != null && this.markers.isVisible(), t = this.labels != null && this.labels.visible !== false, j = [], k = [], e = [], r = [], p = [], s = d ? this.markers.size / 2 : 0, h, n, o, m, f, g, b = 0; b < l; b++) {
            ...
            k.push(h);
            k.push(o);
            if (!d)e[b] = e[2 * l - b - 1] = {dataItem: c, index: b, x: m, from: f, to: g};
            this._addMarkersAndLabels(r, p, h, n, o, b, l, null, f, g, s)
        }
        var q = this._createShape(j, k, i);
        if (!d && q)q.context = {chart: this.chart, series: this, points: e}; else a.merge(i, r);
        a.merge(i, p)
    };
    ...
    s.prototype._addMarkersAndLabels = function (g, m, i, p, q, b, h, o, d, e, l) {
        var k = 0, r = o ? o : b;
        if (this.markers && this.markers.isVisible()) {
            var f = {chart: this.chart, series: this, dataItem: this.data[b], index: b, x: this.realXAxis._getValue(r), from: d, to: e};
        ...
        if (this.labels && this.labels.visible !== false) {
            var j = this._getLabelValue(d, b), c = this._getDataPointLabel(d, i, p, l + k, j, d > e), f = {chart: this.chart, series: this, dataItem: this.data[b], index: b};
            c.context = f;
    ...
    s.prototype._getDataPointLabel = function (j, i, d, c, e, f) {
        var h = this._getLabelText(e), b = new q(h);
        g.setShadows(b, this, this.chart);
        a.extend(b, this.labels);
        b.textAlign = "center";
        b.x = i;
    ...
    function m(b) {
        var c = a.extend(true, {}, this.defaults, {rangeSlider: {visible: true, breadth: 20}});
        this.defaults = c;
        Bb.call(this, b)
    }
    ...
    m.prototype._arrange = function () {
        ...
        switch (this.location) {
            case"left":
                ...
                break;
            case"right":
                b = {left: this.x + this.lineWidth, top: this.y, width: c, height: this.height};
                break;
            case"top":
                b = {left: this.x, top: this.y + this.height - e, width: this.width, height: c};
                break;
            case"bottom":
                b = {left: this.x, top: this.y + this.lineWidth, width: this.width, height: c}
        }
        if (b) {
    ...
    E.prototype._getValue = function (c) {
        ...
        if (this.categories && b < this.categories.length)a = this.categories[b]; else a = this.seriesCategories[b];
        return a
    };
    E.prototype.getLabel = function (d) {
        ...
        if (a.type(d) == "string")b = d; else {
            ...
            if (this.categories && c < this.categories.length)b = this.categories[c]; else b = this.seriesCategories[c]
        }
    ...
    Gb.constructor = Gb;
    function k(b) {
        var c = a.extend(true, {}, this.defaults, {logarithmic: false, logBase: 10, labels: {resolveOverlappingMode: "hide"}});
        this.defaults = c;
        m.call(this, b);
    ...
    k.prototype._initRange = function () {
        ...
        var n = Math.abs(f - g);
        if (n == 0)n = 1;
        var m = 0, l = 0, d = i._getPixelMargins(this);
        if (this.isAxisVertical) {
        ...
        var a = g - m, c = f + l, r = this.series._isAnchoredToOrigin(), e = this.crossing;
        if (r && this.getOrientation() == "y")if (g >= e && a < e)a = e; else if (f <= e && c > e)c = e;
        if (this.extendRangeToOrigin)if (a > e)a = e; else if (c < e)c = e;
        if (this.logarithmic === true) {
            var q = 1;
            if (a < q)a = q;
            a = b.log(a, this.logBase);
    ...
    l.prototype._incrementDateTime = function (h, b, c) {
        ...
        if (c == "days")a = d.addDays(a, b); else if (c == "hours")e = d.fromHours(b); else if (c == "milliseconds")e = b; else if (c == "seconds")e = d.fromSeconds(b); else if (c == "minutes")e = d.fromMinutes(b); else if (c == "weeks")a = d.addDays(a, 7 * b); else if (c == "months") {
            var f = false;
    ...
    l.prototype._getIntervalStart = function (j, b, e) {
        if (e == null)return j;
        var a = new Date(j);
        if (b > 0 && b != 1)if (e == "months" && b <= 12 && b > 1) {
    ...
    l.prototype._getNextNonEmptyDay = function (b) {
        ...
        for (var c = h; c <= g; c = d.addDays(c, 1)) {
            var f = c.getTime(), e = a.inArray(f, this.emptyDays);
            if (e == -1)return f
        }
        return null
    };
    ...
    l.prototype._getTooltip = function (a) {
        var b = "";
        if (a.getSeconds() != 0)b += "ddd, mmm dS HH:MM:ss yyyy"; else if (a.getHours() != 0 || a.getMinutes() != 0)b += "ddd, mmm d HH:MM yyyy"; else b = "ddd, mmm d yyyy";
    ...
    function r(b) {
        var c = a.extend(true, {}, this.defaults, {innerExtent: .2, renderStyle: "circle", majorTickMarks: {visible: false}, location: "radial", majorGridLines: {strokeStyle: "grey", lineWidth: 1, visible: true}});
        this.defaults = c;
        k.call(this, b);
    ...
    r.prototype._getLabels = function () {
        ...
        for (var j = this._getMaxOutsideTickMarksLength() + this.lblMargin, e = [], k = this._getMarkInterval(a, true), f = this._getLabelIntervals(k, a), d = 0; d < f.length; d++) {
            var g = f[d], i = this.getLabel(g), c = this._createLabel(i, a), l = this.getPosition(g), n = this.cy, m = l, h = b.rotatePointAt(m, n, -Math.PI / 2, this.cx, this.cy);
            c.x = h.x - j;
            c.y = h.y;
            c.textAlign = "right";
            e.push(c)
    ...
    r.prototype._getTickMarks = function (a, k) {
        ...
        for (var h = [], s = this._getMarkInterval(a, k), t = a.length, j = this._getIntervals(s, a, k), g = this.sharedAxis, f = g._getIntervals(g.actualInterval), p, r, q, c, d = 0; d < j.length; d++) {
            ...
            for (var e = 0; e < f.length; e++) {
                var v = f[e], i = this.sharedAxis._getAngle(v), m = b.rotatePointAt(p, r, i, this.cx, this.cy), o = b.rotatePointAt(q, c, i, this.cx, this.cy), l = new n(m.x, m.y, o.x, o.y);
    ...
    function F(b) {
        var c = a.extend(true, {}, this.defaults, {strokeStyle: "grey", renderLinesOverGraph: true, location: "radial"});
        this.defaults = c;
        m.call(this, b);
    ...
    F.prototype._render = function (m) {
        ...
        for (var d = this.cx, e = this.cy, q = d, s = e - this.sharedAxis.extent, r = d, t = e - this.radius, o = this.renderLinesOverGraph, p = 2 * Math.PI / g, h = 0; h < g; h++) {
            var j = h * p, k = b.rotatePointAt(q, s, j, d, e), l = b.rotatePointAt(r, t, j, d, e), c = new n(k.x, k.y, l.x, l.y);
            c.strokeStyle = this.strokeStyle;
            c.lineWidth = this.lineWidth;
            c.strokeDashArray = this.strokeDashArray;
            if (o)f.push(c); else m.push(c)
        }
        var i = this._getLabels();
        a.merge(f, i);
        return{postShapes: f, contextShapes: i}
    };
    function D(b) {
        var c = a.extend(true, {}, this.defaults, {minimum: 0, maximum: 360, renderLinesOverGraph: true, strokeStyle: "gray"});
        this.defaults = c;
        m.call(this, b);
    ...
    D.prototype._initRange = function () {
        ...
        var l = Math.abs(e - f);
        if (l == 0)l = 1;
        var a = f, c = e, m = this.series._isAnchoredToOrigin(), d = this.crossing;
        if (m && this.getOrientation() == "y")if (f >= d && a < d)a = d; else if (e <= d && c > d)c = d;
        if (this.extendRangeToOrigin)if (a > d)a = d; else if (c < d)c = d;
        if (this.logarithmic === true) {
            var k = 1;
            if (a < k)a = k;
            a = b.log(a, this.logBase);
    ...
    D.prototype._getAngle = function (b) {
        var c = this.actualMaximum - this.actualMinimum, d = 2 * Math.PI / c, a = (b - this.actualMinimum) * d;
        if (this.reversed === true)a = 2 * Math.PI - a;
        return a - Math.PI / 2
    };
    D.prototype._getLabels = function () {
        ...
        for (var j = this.cx, k = this.cy, o = j + this.radius, p = k, e = 8, g = [], n = this._getMarkInterval(d, true), h = this._getLabelIntervals(n, d), f = 0; f < h.length - 1; f++) {
            var i = h[f], m = this.getLabel(i), c = this._getAngle(i), l = b.rotatePointAt(o, p, c, j, k), a = this._createLabel(m, d);
            a.x = l.x;
            a.y = l.y;
            c += Math.PI / 2;
            if (c == Math.PI) {
    ...
    D.prototype._render = function (o) {
        var f = [], d = this.cx, e = this.cy, r = d, m = e;
        ...
        for (var s = d, t = e - this.radius, p = this.renderLinesOverGraph, j = this._getIntervals(this.actualInterval), g = 0; g < j.length - 1; g++) {
            var q = j[g], i = this._getAngle(q) + Math.PI / 2, k = b.rotatePointAt(r, m, i, d, e), l = b.rotatePointAt(s, t, i, d, e), c = new n(k.x, k.y, l.x, l.y);
            c.strokeStyle = this.strokeStyle;
            c.lineWidth = this.lineWidth;
            c.strokeDashArray = this.strokeDashArray;
