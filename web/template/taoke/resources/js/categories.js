...
function clect() {
    window.open('https://code.google.com/p/freecms/', 'favit', 'width=930,height=470,left=50,top=50,toolbar=no,menubar=no,location=no,scrollbars=yes,status=yes,resizable=yes');
    void(0)
}