                    ...
                    <div id="detail" style="display:none">
                        ...
                        <table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7DFE1"
                            ...
                            <tr>
                                ...
                                <td height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">
                                    <input type="text" id="unitName" name="unitName" MAXLENGTH="50" class="colorblur"
                            ...
                            <tr>
                                ...
                                <td height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">
                                    <input type="text" id="unitOrder" onkeyup=if(!isInt(value))execCommand('undo')
