        ...
        <TABLE width="100%" border=0 align=center cellpadding="2"
            ...
            <TR class=summary-title>
                <TD height="30" align=left style="padding-left: 10px;">
                    ...
                    时间范围：
                    <input name="visit.starttime" id="starttime" class="Wdate" type="text" size="24"
                           value="${visit.starttimeStr }"
                           onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                    至
                    <input name="visit.endtime" id="endtime" class="Wdate" type="text" size="24"
    ...
    <table id="MyDataList" cellspacing="1" cellpadding="1"
        ...
        <s:iterator value="visitList" id="obj" status="bean">
            <TR class="tdbg" onMouseOver="this.className='tdbg-dark';"
                ...
                <TD align="left">
                    <a href='../../visit_channel.do?channelid=<s:property value="channelid"/>'
                       target='_blank'><s:property value="channelName"/></a>
                </TD>
                <TD align="left">
