            ...
            <TR class=summary-title>
                <TD height="30" align=left style="padding-left: 10px;">
                    ...
                    <select name="comment.objtype">
                        ...
                        <option value="<s:property value="key"/>" ${comment.objtype==bean.key ?"selected":"" }>
                                <s:property value="value"/>
                            </s:iterator>
                    </select>
                    时间范围：
                    <input name="comment.starttime" id="starttime" class="Wdate" type="text" size="24"
                           value="${comment.starttimeStr }"
                           onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                    至
                    <input name="comment.endtime" id="endtime" class="Wdate" type="text" size="24"
                           value="${comment.endtimeStr }"
                           onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
