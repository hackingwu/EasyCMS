        ...
        <TABLE width="100%" border=0 align=center cellpadding="2"
            ...
            <TR class=summary-title>
                <TD height="30" align=left style="padding-left: 10px;">
                    ...
                    时间范围：
                    <input name="guestbook.starttime" id="starttime" class="Wdate" type="text" size="24"
                           value="${guestbook.starttimeStr }"
                           onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                    至
                    <input name="guestbook.endtime" id="endtime" class="Wdate" type="text" size="24"
                           value="${guestbook.endtimeStr }"
                           onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
