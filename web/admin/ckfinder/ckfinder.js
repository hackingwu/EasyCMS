...
(function () {
    var a = (function () {
        var f = {jY: 'B8MI1HT', _: {}, status: 'unloaded', basePath: (function () {
    ...
    (function () {
        ...
        CKFinder.prototype = {create: function (f) {
            ...
            if (f < 200)f = 200;
            if (g < 200)g = 200;
            var h = parseInt((window.screen.height - g) / 2, 10), i = parseInt((window.screen.width - f) / 2, 10), j = 'location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,width=' + f + ',height=' + g + ',top=' + h + ',left=' + i, k = a.env.webkit ? 'about:blank' : '', l = window.open(k, 'CKFinderpopup', j, true);
            if (!l)return false;
        ...
        CKFinder.dialog = {add: function (f, g) {
    ...
    a.ajax = (function () {
        var i = function () {
            ...
            var q = a.eq || a.jt, r = n.responseText, s = q.lang.ErrorMsg[!r ? 'XmlEmpty' : 'XmlError'] + '<br>';
    ...
    h.dE.prototype = (function () {
        ...
        return{kk: function () {
            ...
            if (!l[k]) {
                var m = l[k] = j(n, k);
                if (n.$.addEventListener && !g)n.$.addEventListener(k, m, !!a.event.jP); else if (n.$.attachEvent)n.$.attachEvent('on' + k, m);
            }
    ...
    (function () {
        var m = {};
        a.lang = {ko: {cs: 1, da: 1, de: 1, el: 1, en: 1, es: 1, 'es-mx': 1, et: 1, fa: 1, fi: 1, fr: 1, he: 1, hu: 1, it: 1, ja: 1, lv: 1, lt: 1, nb: 1, nl: 1, no: 1, nn: 1, pl: 1, 'pt-br': 1, ru: 1, sk: 1, sl: 1, sv: 1, tr: 1, 'zh-cn': 1, 'zh-tw': 1}, load: function (n, o, p) {
    ...
    (function () {
        ...
        var o = g && f.version < 7, p = g && f.version == 7, q = o ? a.basePath + 'images/spacer.gif' : p ? 'about:blank' : 'data:image/png;base64,', r = k.kE('<div style="width:0px;height:0px;position:absolute;left:-10000px;background-image:url(' + q + ')"></div>', a.document);
        ...
        m.add('connector', {bM: [], bz: function (q) {
            q.on('appReady', function () {
                ...
                q.connector.sendCommand('Init', s, function (t) {
                    ...
                    var w = t.selectSingleNode(v + "\x40\160\154\165\147\151\x6e\x73"), x = w && w.value;
    ...
    (function () {
        ...
        m.add('folder', {bM: ['resource', 'connector', 'acl'], bz: function (s) {
            ...
            s.bD('RemoveFolder', {exec: function (t) {
                var u = t.aV;
                if (u) {
            ...
            s.bD('CreateSubFolder', {exec: function (t) {
                var u = t.aV;
            ...
            s.bD('RenameFolder', {exec: function (t) {
                var u = t.aV;
                if (u) {
    ...
    (function () {
        ...
        function q() {
            ...
            y.prototype = {select: function (z) {
                ...
                this.bi.setStyles({height: z.$.offsetHeight + 'px', top: z.$.offsetTop - A + 'px', display: 'block'});
            }, mc: function (z) {
    ...
    (function () {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], v = ['Node', "\x6d\x65\x73\163\x61\x67\145"];

        function w(G) {
            var H = v.reverse().join(''), I = G.tools.of(), J = I['se' + "\x74\110\x74\155\x6c"];
            J.call(I, G.qX());
        ...
        m.add('filesview', {bM: ['foldertree'], onLoad: function G() {
            ...
            G.on('uiReady', function M(J) {
                ...
                G.bD('RenameFile', {exec: function (N) {
                    var O = function (Q, R) {
                        try {
                            P.rename(R);
                        } catch (S) {
                ...
                G.bD('DeleteFile', {exec: function (N) {
                    var O = L.data().cG;
                ...
                if (G.eU) {
                    ...
                    G.eU({selectFile: {label: G.lang.Select, onClick: function () {
                        var N = G.aG['filesview.filesview'][0], O = N.tools.dH();
                ...
                if (G.bj) {
                    ...
                    G.bj.kh(function S(N, O) {
                        ...
                        if (P) {
                            ...
                            var Q = P.folder.acl, R = {viewFile: Q.fileView ? a.aS : a.aY, downloadFile: Q.fileView ? a.aS : a.aY, renameFile: Q.fileRename ? a.aS : a.aY, deleteFile: Q.fileDelete ? a.aS : a.aY};
            ...
            G.bD('filesviewFocus', {exec: function (J) {
                var K = J.layout.pn(), L = J.aG['filesview.filesview'][0], M = L.tools.dH();
                K.focus();
                M && M.focus();
            }});
        }});
        ...
        function z() {
            ...
            G.bh('RenderFiles', ['requestRenderFiles'], function Y(L) {
                ...
                if (!M.files.length)N = M.files; else if (M.cN == 'date' && M.cP.date)N = M.cP.date; else if (M.cN == 'size' && M.cP.size)N = M.cP.size; else if (M.cN == 'filename' && M.cP.filename)N = M.cP.filename; else {
                    ...
                    if (M.cN == 'date') {
                        ...
                        N.sort(function (Z, aa) {
                            var aT = Z.name.toLowerCase(), bm = aa.name.toLowerCase();
                            return aT < bm ? -1 : aT > bm ? 1 : 0;
                        });
                        M.cP.filename = N;
                    }
                }
                var V = i.extend({eu: 1, dA: this.data().dA, display: this.data().display}, L.data, {files: N}, true);
                    ...
                    try {
                        ...
                        if (P.dA == 'list') {
                            ...
                            if (g) {
                                ...
                                if (P.eu)this.tools.fF().setHtml(this.tools.lz() + u[1] + T + u[2]); else V.appendHtml(T);
                            } else U.setHtml('');
                        } else {
                            ...
                            if (R && R == 'list') {
                                var Y = this.tools.fF();
                                if (Y && g)Y.remove(); else if (Y)Y.setHtml('');
                            }
                            if (P.eu)U.setHtml(T); else U.appendHtml(T);
                        }
        ...
        a.aL.File.prototype = {rename: function (G) {
            ...
            if (K && (K = K[0])) {
                if (J.config.thumbsEnabled && J.rQ.rO.test(K)) {
                    ...
                    return J.connector.composeUrl('Thumbnail', {FileName: I}, L.folder.type, L.folder);
                }
    ...
    (function () {
        m.add('dragdrop', {bM: ['foldertree', 'filesview', 'contextmenu', 'dialog'], onLoad: function r(q) {
            ...
            a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function z(u) {
                ...
                v.oW('beforeDraggable', y, function I(A, B) {
                    ...
                    function G(J) {
                        ...
                        if (J)J.removeListener(); else q.document.removeListener('mouseup', G);
    ...
    (function () {
        ...
        function q(w) {
            ...
            if (z.getName() == 'input')i.setTimeout(function () {
                var D = this.app.aG['filesview.filesview'][0], E = D.data(), F = {dA: E.dA, cN: E.cN, display: CKFinder.tools.clone(E.display)};
    ...
    (function () {
        ...
        m.add('mobile', {bM: ['foldertree', 'filesview'], bz: function t(s) {
            ...
            s.on('uiReady', function A(v) {
                ...
                s.on('afterCommandExecDefered', function D(B) {
                    if (B.data.name == 'RemoveFile') {
                        var C = {folder: B.data.folder, ib: x[0]};
                        y.oW('requestShowFolderInfo', C);
                    }
                });
                y.on('afterShowFileInfo', function C(B) {
                    if (this.bn().getText())return;
                    y.oW('requestShowFolderInfo', {ib: x[0], folder: x[0].data().folder});
                });
            });
        }});
        function p() {
    ...
    (function () {
        m.add('uploadform', {bM: ['formpanel', 'button'], md: function () {
                ...
                y.oW('requestUploadFileForm', null, function () {
                    if (y.cS('upload').bu == a.eV)setTimeout(function () {
                        ...
                        if (z) {
                            ...
                            if (A.$.click)A.$.click(); else A.focus();
                        }
                    }, 0);
                });
            }});
        ...
        function p() {
            ...
            w.bh('UploadFileForm', ['requestUploadFileForm'], function D(A) {
                ...
                this.oW('beforeUploadFileForm', {folder: B, step: 1}, function J(E, F) {
                    if (E || x())return;
                    ...
                    this.oW('beforeUploadFileForm', {folder: H, step: 2}, function S(K, L) {
                        try {
                            if (G.dc == 'upload')this.oW('requestUnloadForm', function () {
                                ...
                                this.oW('requestLoadForm', {html: O, dq: i.bind(function (T) {
                                    return y.call(P, T, H);
            ...
            w.tools.qL = function () {
                var E = this;
                if (E.gq === undefined) {
                    var A = f.isCustomDomain(), B = 'ckf_' + i.getNextNumber(), C = '<iframe id="' + B + '"' + ' name="' + B + '"' + ' style="display:none"' + ' frameBorder="0"' + (A ? " src=\"javascript:void((function(){document.open();document.domain='" + document.domain + "';" + 'document.close();' + '})())"' : '') + ' tabIndex="-1"' + ' allowTransparency="true"' + '></iframe>', D = E.ib.app.document.bH();
                    D.appendHtml(C);
                    E.gq = D.dB();
                }
                return E.gq;
        ...
        function q(w, x, y) {
            ...
            var B = 0, C = x.$.files[B], D = C.size || C.fileSize, E = C.name || C.fileName, F = parseInt(z.config.uploadMaxSize, 10);
            if (F && D > F) {
            ...
            H.addEventListener('load', function (M) {
                var N = /<script.*>\s*window\.parent\.OnUploadCompleted\(\s*'(.*)'\s*,\s*'(.*)'\s*\).*<\/script>/, O = M.target.responseText, P = O.match(N);
                if (!P) {
                    J('', 'Error: ' + O);
                    return;
                }
    ...
    (function () {
        ...
        CKFinder.addPlugin('flashupload', {appReady: function (q) {
    ...
    (function () {
        ...
        m.add('basket', {bM: ['foldertree', 'filesview', 'contextmenu'], basketToolbar: [
            ...
            r.bD('FolderPasteCopyBasket', {exec: function (v) {
                var w = v.aV;
                if (!w)return;
                q(v, w, v.basketFiles);
            }});
            r.bD('FolderPasteMoveBasket', {exec: function (v) {
            ...
            r.on('uiReady', function E(v) {
                ...
                r.bD('TruncateBasket', {exec: function (F) {
                ...
                r.bD('RemoveFileFromBasket', {exec: function (F) {
                ...
                r.bD('OpenFileFolder', {exec: function (F) {
                    var G = F.aG['filesview.filesview'][0].data().cG;
                ...
                for (var B = 0; B < z.length; B++) {
                    ...
                    z[B].on('beforeShowFolderFiles', function O(F) {
                        if (!(F.data.folder instanceof a.aL.BasketFolder))return;
                        F.cancel(1);
                        this.app.oW('requestRenderFiles', {files: r.basketFiles, mj: r.lang.BasketEmpty, eu: 1, folder: F.data.folder});
                    ...
                    for (var G in F.plugins) {
                        ...
                        for (var H = 0; H < G.basketToolbar.length; H++) {
                            ...
                            if (!J.command) {
                                ...
                                F.bD('BasketToolbar_' + I[0], {exec: function (M) {
                                    K(M.cg);
                                }});
                                J.command = L;
                            }
                    ...
                    for (var G in F.plugins) {
                        ...
                        for (var H = 0; H < G.basketFileContextMenu.length; H++) {
                            ...
                            if (!J.command) {
                                ...
                                F.bD('BasketContextMenu_' + I[0], {exec: function (M) {
                                    L(M.cg);
                                }});
                                J.command = K;
                            }
    ...
    (function () {
        ...
        a.dialog = function (P, Q) {
            ...
            this._ = {app: P, element: T.element, name: Q, hB: {width: 0, height: 0}, size: {width: 0, height: 0}, contents: {}, buttons: {}, iX: {}, tabs: {}, cU: [], gx: null, nM: null, gV: 0, qF: null, eC: false, eO: [], gu: 0, hasFocus: false};
            this.bO = T.bO;
